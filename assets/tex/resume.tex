...
\usepackage[T1]{fontenc}  % better font encoding for small-caps
\usepackage{lmodern}      % Latin Modern fonts, include bold small-caps support where available
...
\begin{center}
    \textbf{\Huge \scshape Jehu Shalom Amanna} \\ \vspace{3pt}
    \small
    \faMobile \hspace{.5pt} \href{tel:919008141866}{+91 9008 141 866}
    $|$
    \faAt \hspace{.5pt} \href{mailto:jehuamanna@gmail.com}{jehuamanna@gmail.com}
    $|$
    \faLinkedinSquare \hspace{.5pt} \href{https://www.linkedin.com/in/jehuamanna}{LinkedIn}
    $|$
    \faGithub \hspace{.5pt} \href{https://github.com/jehuamanna}{GitHub}
    $|$
    \faGlobe \hspace{.5pt} \href{https://jehuamannna.com}{Portfolio}
    $|$
    \faMapMarker \hspace{.5pt} \href{https://maps.app.goo.gl/t6aaKZFG3cnca37Y7}{Udupi, India}
\end{center}
